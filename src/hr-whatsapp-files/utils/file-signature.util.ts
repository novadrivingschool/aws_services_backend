/* src/hr-whatsapp-files/utils/file-signature.util.ts
 *
 * Magic-byte sniffing — never trusts the Content-Type the client declared.
 * Identical approach to loa-files/utils/file-signature.util.ts.
 */
import { AllowedMimeType } from '../hr-whatsapp-files.constants';
...
/** Real MIME type of `buffer`, or `null` when it is not one of the allowed formats. */
