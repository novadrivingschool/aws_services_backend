/* src/loa-files/filters/upload-exception.filter.ts
 *
 * Turns multer's terse errors into messages that tell the user what is
 * allowed. Same rationale as helpdesk-files/filters/upload-exception.filter.ts.
 */
import {
  ArgumentsHost,
  Catch,
...
import { POLICY_SUMMARY } from '../loa-files.constants';
